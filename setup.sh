...
echo "  2. Copy and paste the following prompt to your Antigravity Agent in the chat:"
echo ""
echo "     \"Please add AGENTS.md and GEMINI.md to my Workspace Rules, and add all files in .agents/workflows/ to my Workspace Workflows.\""
echo ""
echo "  3. Use @agent-name to address specific agents"
echo ""
